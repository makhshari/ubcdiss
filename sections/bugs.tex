...
We asked our survey participants how frequently they face each bug (sub)category. The most frequent categories of bugs are general development issues (48\%), device management issues (29\%), and messaging issues (19\%). Connectivity issues are the most frequent bug category with more than half of developers face it frequently. Hardware, and messaging issues are among the most frequent bug categories after connectivity issues. 
